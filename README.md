...
本项目提供了一个用于排版南京大学科技报告的XeLaTeX模板。该模板严格遵循南京大学学术委员会对科技报告的排版格式要求以及相应的国家标准规范，可帮助南京大学的同学们方便地排版出漂亮的科技报告。

虽然该模板主要用于排版南京大学的科技报告，但亦可经过简单的设置或修改用于排版国内其他大学的科技报告。

## 项目主页

本项目主页地址为：[http://haixing-hu.github.io/nju-report/][homepage]

[homepage]: http://haixing-hu.github.io/nju-report/

## 功能特色

* 此模版用于生成符合南京大学科技报告排版要求的科技报告；
* 使用XeLaTeX作为排版引擎，论文源码需要使用UTF-8编码；
* 自动生成中文封面、英文封面、中文摘要页、英文摘要页、科技报告出版授权书等必需页面；
